...
cc.Class({
    ...
    applyLayout: function () {
        ...
        // this.mcClock.container.active = false;
    ...
    //===========================OVERRIDE===============================================================================
    //==================================================================================================================
    onResetCard: function (seatId, cards) {
        this.rootGame.resetCard(seatId, cards);
    },
    
    onStartGame: function () {
        var seat = this.tableVO.getSeatByUserId(this.tableVO.ownerId);
        if (seat) {
            this.playSound(seat.user, [["SBV_0351", "SBV_0352", "SBV_0353", "SBV_0354", "SBV_0355"], ["SBV_0435", "SBV_0436", "SBV_0437", "SBV_0438", "SBV_0266"]])
        }
    ...
    onSitdown: function (seatId, user) {
        this.playSound(user, [["SBV_0341", "SBV_0342", "SBV_0343", "SBV_0344", "SBV_0345"], ["SBV_0425", "SBV_0426", "SBV_0427", "SBV_0428", "SBV_0429"]])
        CoreGame.prototype.onSitdown.call(this, seatId, user);
    },

    onUserExitGame: function (seatId) {
        var seat = this.tableVO.getSeatBySeatId(seatId);
        if (seat) this.playSound(seat.user, [["SBV_0346", "SBV_0347", "SBV_0348", "SBV_0349", "SBV_0350"], ["SBV_0430", "SBV_0431", "SBV_0432", "SBV_0433", "SBV_0434"]])
        CoreGame.prototype.onUserExitGame.call(this, seatId);
    },
    ...
    onBinhLung: function (seatId, isLung) {
        ...
        if(mySeat.id === seatId && isLung) {
            this.playSound(mySeat.user, [["SBV_0356", "SBV_0357", "SBV_0358", "SBV_0359", "SBV_0360"], ["SBV_0440", "SBV_0441", "SBV_0442", "SBV_0443", "SBV_0444"]])
        }
    ...
    onHanlerXepXong: function () {
        if (this.mcListButton.isMauBinh) {
            window.facade.sendNotification(LobbyMessage.SHOW_ALERT_WITH_CONFIRM,
                {
