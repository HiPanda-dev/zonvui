    ...
    // INSTANCE MEMBERS
    {
        ...
        setCards: function (arrCards) {
            ...
            for (var i = 0; i < arrCards.length; i++) {
                ...
                if (!this.cards[idx]) this.cards[idx] = [];
                this.cards[idx].push(arrCards[i]);
            }
        }, 

        getCardsChi: function (chiIndex) {
            if (chiIndex === LogicBinh.INDEX_CHI1) return this.cardsChi1;
            if (chiIndex === LogicBinh.INDEX_CHI2) return this.cardsChi2;
            if (chiIndex === LogicBinh.INDEX_CHI3) return this.cardsChi3;
        },
