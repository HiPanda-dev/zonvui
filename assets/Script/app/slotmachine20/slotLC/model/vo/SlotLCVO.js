...
export default class SlotLCVO extends BaseVO{
    ...
    updateData(data) {
      ...
      if(data.m !== ""){
        ...
        else if(this.prize >= this.listBet[this.bet -  1] * 70) this.typeResult = SlotLCVO.BIG_WIN;
        else this.typeResult = SlotLCVO.NORMAL_WIN;
    ...
    updateChoiThuData() {
      ...
      var arrData = [];
  //     arrData[0] = {
	// "i": 200,	"c": 101,	"d": {		"r": 1,		"c": 67000,		"b": 6332492,		"jp": 0,		"mg": {			"vb": 2000,			"v": 66000,			"s": "x1x3x2x3x2x0x3"		},		"fs": 8,		"ls": [			{				"id": 16,				"i": 4,				"v": 1000			}		],		"i": "342213423A2AA76"	},	"m": ""};
