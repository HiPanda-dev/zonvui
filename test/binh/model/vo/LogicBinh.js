        ...
        // STATIC MEMBERS
        {
            ...
            namePerChi: function (cardsChi) {
                ...
                for (var i = 0; i < 3; i++) {
                    ...
                    if (results[i].type === this.IDX_MAU_THAU) type = this.getIdxMauThau(cardsChi[i]);
                    resultCardsName[i] = this.getTypeCardsName(type);
                }
                return resultCardsName;
            },

            getIdxMauThau(theCards) {
                Utility.sortArray(theCards, "DESCENDING");
                this.moveCard2ToEnd(theCards);
                var card = new CardVO(theCards[0]);
                if (card.numBinh === 2) return this.IDX_MAU_THAU_4;
                if (card.numBinh === 3) return this.IDX_MAU_THAU_5;
                if (card.numBinh === 4) return this.IDX_MAU_THAU_6;
                if (card.numBinh === 5) return this.IDX_MAU_THAU_7;
                if (card.numBinh === 6) return this.IDX_MAU_THAU_8;
                if (card.numBinh === 7) return this.IDX_MAU_THAU_9;
                if (card.numBinh === 8) return this.IDX_MAU_THAU_10;
                if (card.numBinh === 9) return this.IDX_MAU_THAU_11;
                if (card.numBinh === 10) return this.IDX_MAU_THAU_12;
                if (card.numBinh === 11) return this.IDX_MAU_THAU_13;
                if (card.numBinh === this.CARD_A) return this.IDX_MAU_THAU_A;

                return this.IDX_MAU_THAU;
            ...
            check_3ChiThung: function (cardsChi) {
                ...
                var chi3 = this.check_Thung_3(cardsChi[2]);
            ...
            getTypeCardsName: function (idx) {
                switch (idx) {
                    ...
                    case LogicBinh.IDX_RONG_CUON:
                        return "Rồng cuốn";
                    case LogicBinh.IDX_MAU_THAU_4:
                        return "Mậu thầu 4";
                    case LogicBinh.IDX_MAU_THAU_5:
                        return "Mậu thầu 5";
                    case LogicBinh.IDX_MAU_THAU_6:
                        return "Mậu thầu 6";
                    case LogicBinh.IDX_MAU_THAU_7:
                        return "Mậu thầu 7";
                    case LogicBinh.IDX_MAU_THAU_8:
                        return "Mậu thầu 8";
                    case LogicBinh.IDX_MAU_THAU_9:
                        return "Mậu thầu 9";
                    case LogicBinh.IDX_MAU_THAU_10:
                        return "Mậu thầu 10";
                    case LogicBinh.IDX_MAU_THAU_11:
                        return "Mậu thầu J";
                    case LogicBinh.IDX_MAU_THAU_12:
                        return "Mậu thầu Q";
                    case LogicBinh.IDX_MAU_THAU_13:
                        return "Mậu thầu K";
                    case LogicBinh.IDX_MAU_THAU_A:
                        return "Mậu thầu Át";    
                }
                return "";
            },
