...
var BinhCard = cc.Class({
    ...
    buildUI: function (cardId, isMove) {
        ...
        this.cardBack = AssetVO.getTextureGameAtlas('card_back_binh');
    ...
    flipCard: function (delay) {
        var width = this.width;
        TweenLite.to(this, 0.2, {width: 0, delay: delay});
        TweenLite.to(this, 0.2, {width: width, delay: delay + 0.2});
        TweenLite.delayedCall(delay + 0.2, function () {
            this.setCardState(BinhCard.FACE_UP);
        }.bind(this));
    },
    ...
    addBorderCard: function () {
        ...
        border.getComponent(cc.Sprite).spriteFrame = AssetVO.getTextureGameAtlas('card_border');
        border.active = false;
        this.addChild(border);
    },

    showBorderCard: function (isShow) {
        this.getChildByName('border').active = isShow;
    },
